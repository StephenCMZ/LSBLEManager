#
#  Be sure to run `pod spec lint LSBLEManager.podspec.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author             = { "Stephen" => "StephenCMZ@live.com" }
  # Or just: s.author    = "Stephen"
  # s.authors            = { "Stephen" => "StephenCMZ@live.com" }
  # s.social_media_url   = "http://twitter.com/Stephen"
